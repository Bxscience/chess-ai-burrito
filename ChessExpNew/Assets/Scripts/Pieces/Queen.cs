...
public class Queen : Piece
{
    ...
    public override List<Move> getAllMoves(GameObject[] arr) { // a combination of the rook and bishop 
        ...
        for (int a = 1; a < 8; a++) {
            if (transform.position.z + 3.5 + a <= 7) {
                if (arr[GetIndex((int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f))] == null)
                    moves.Add(new Move((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f), (int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f),
                    200,
                    0));
                else {
                    if (arr[GetIndex((int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f))].GetComponent<Piece>().isWhite != isWhite)
                        moves.Add(new Move((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f), (int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f),
                        PieceValues(arr[GetIndex((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f))]),
                        PieceValues(arr[GetIndex((int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f))])));
                    break;                
                }
            }
            else
        ...
        for (int a = 1; a < 8; a++) {
            if (transform.position.x + 3.5 + a <= 7) {
                if (arr[GetIndex((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f + a))] == null)
                    moves.Add(new Move((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f), (int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f + a),
                    200,
                    0));
                else {
                    if (arr[GetIndex((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f + a))].GetComponent<Piece>().isWhite != isWhite)
                        moves.Add(new Move((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f), (int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f + a),
                        PieceValues(arr[GetIndex((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f))]),
                        PieceValues(arr[GetIndex((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f + a))])));
                    break;                
                }
            }
            else
        ...
        for (int a = 1; a < 8; a++) {
            if (transform.position.z + 3.5 + a <= 7 && transform.position.x + 3.5 + a <= 7) {
                if (arr[GetIndex((int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f + a))] == null)
                    moves.Add(new Move((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f), (int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f + a),
                    200,
                    0));
                else {
                    if (arr[GetIndex((int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f + a))].GetComponent<Piece>().isWhite != isWhite)
                        moves.Add(new Move((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f), (int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f + a),
                        PieceValues(arr[GetIndex((int) (transform.position.z + 3.5f), (int) (transform.position.x + 3.5f))]),
                        PieceValues(arr[GetIndex((int) (transform.position.z + 3.5f + a), (int) (transform.position.x + 3.5f + a))])));
                    break;                
                }
            }
            else
